    ...
    topicos: [
      ...
      },
      {
        ...
        passos: [
          ...
          "Escaneie o termo assinado ou tire uma foto: PDF, PNG ou JPEG, até 10 MB.",
          "Abra o motorista e clique em Importar termo assinado.",
          "Escolha o arquivo, confira a data da assinatura e clique em Importar.",
          "Ver termo mostra o arquivo guardado. Histórico do termo mostra todos os registros, e nenhum é apagado.",
          "Se o motorista revogar, clique em Registrar que revogou: os vídeos dele voltam a ficar trancados.",
