/* "Servidor" do modo de testes local: responde as mesmas rotas da API dentro do navegador, sem servidor e sem banco.
   As regras de acesso seguem o backend (servidor/backend/routes/*.py): gestor só vê a própria empresa, motorista só o que é dele. */
...
// ---------- celular (mesma regra de servidor/backend/identifiers.py) ----------
