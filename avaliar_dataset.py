...
Etapa 2, avaliar (rápida, só lê os CSVs):
  ...
  python avaliar_dataset.py avaliar avaliacao/ --classificador     # precisa de requirements-eval.txt
...
def classifier(rows: list[dict]) -> dict:
    try:
        ...
        return {"erro": "scikit-learn não instalado: pip install -r requirements-eval.txt"}
